...
/* ─── Page ─── */
export default function RegisterSection({ isVisible, opacity, isScrolling, blackFade, screenHeight, navbarHeight, autoZoomRef }) {
  const [searchParams] = useSearchParams();
  const location = useLocation();
  const preselectedId = location.state?.preselectEvent ?? searchParams.get('event') ?? '';
  ...
  return (
    <section 
        ...
        style={{
            ...styles.page,
            display: !isScrolling && !isVisible ? 'none' : 'block',
