...
export default function SwitchEventCard({ children, forceStateE = false, isZoomingOut = true, onStateE = () => { }, onBootStateChange = () => { }, scrollYProgress, contentY, onContentHeightChange }) {
    ...
    const handleDown = () => {
        ...
        } else if (bootState === 'E' && !isScrolling) {
            setBlackFade(true);
            setTimeout(() => {
                setBootState('F');
                setBlackFade(false);
                ...
                >
                    ...
                    >
                        ...
                        {(bootState === 'E' || isScrolling) && (
                            ...
                            {typeof children === 'function' ? children({ scrollRef, isScrolling, bootState, nintendoIndex, blackFade, screenHeight, navbarHeight }) : children}
                        </motion.div>
                        </div>
                    </div>
