                    ...
                    >
                        {page === 0 && (
                            <div className="w-full h-full flex flex-col justify-center items-start text-left animate-in fade-in duration-300" style={{ padding: '2.4cqi' }}>
                                <h2
                                    ...
                                    style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "2.8cqi", lineHeight: "1.6", marginBottom: '2.4cqi' }}
                                >
                                    {EVENT.heading}
                                </h2>

                                {EVENT.paragraphs.map((p, i) => (
                                    <p key={i} className="leading-relaxed text-gray-300 w-full" style={{ fontSize: '2.3cqi', marginBottom: '2cqi' }}>
                                        {p}
                                    </p>
                                ))}
                        ...
                        {page === 1 && (
                            <div className="w-full h-full flex flex-col justify-center animate-in fade-in duration-300" style={{ padding: '3.2cqi' }}>
                                <div className="border border-gray-600 bg-white/5 shadow-lg" style={{ borderRadius: '0.8cqi', padding: '2.4cqi' }}>
                                    <div
                                        className="text-white text-center"
                                        style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "2.4cqi", marginBottom: '2.4cqi' }}
                                    >
                                        {EVENT.tracksTitle}
                                    </div>
                                    <ul style={{ display: 'flex', flexDirection: 'column', gap: '1.6cqi' }}>
                                        {EVENT.tracks.map((t) => (
                                            <li key={t.name} className="leading-snug text-gray-300" style={{ fontSize: '2.2cqi' }}>
                                ...
                                <div 
                                    ...
                                    style={{ position: 'absolute', bottom: '2.4cqi', left: '3.2cqi', gap: '0.8cqi' }}
                                >
                                    <span style={{ fontFamily: "'Press Start 2P', monospace", fontSize: "1.4cqi", marginTop: "0.4cqi" }}>&lt;</span>
